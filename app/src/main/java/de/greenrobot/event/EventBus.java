...
public class EventBus {
     ...
     * 一个事件对应的订阅者集合的map集合
     * key:事件class
     * value:订阅者集合,CopyOnWriteArrayList是ArrayList的一个线程安全的变体,用于读多余写的场景
     */
    private final Map<Class<?>, CopyOnWriteArrayList<Subscription>> subscriptionsByEventType;

    /**
     * 一个订阅者对应的所有订阅事件集合的map集合
     * key:订阅者
     * value;订阅者对应的所有订阅事件的集合
     */
    ...
    private void subscribe(Object subscriber, SubscriberMethod subscriberMethod, boolean sticky, int priority) {
        ...
        //把订阅者的信息构造为Subscription对象
        Subscription newSubscription = new Subscription(subscriber, subscriberMethod, priority);
        //如果这个事件没有对应的订阅者则new 一个集合,并把这个集合放到subscriptionsByEventType这个map中中
        ...
        //遍历订阅者集合,如果没有元素或者新的订阅者优先级大的话 加塞
        ...
        //如果为空则创建事件集合并加入到typesBySubscriber中
        ...
        if (sticky) {
            ...
            if (eventInheritance) {
                ...
                //如果不可继承的话,就不过滤了,直接根据订阅的eventType去找事件对象,并发布事件到订阅者中
